...
const config = {
    ...
    RCD_IMAGE_PATH: './https://files.catbox.moe/mkcgyp.jpg',
...
const owner = 'dulakshiimalsha817-source';//𝚐𝚒𝚝𝚑𝚞𝚋 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 එකේ 𝚞𝚜𝚎𝚗𝚊𝚖𝚎 දාන්න 
const repo = 'RAVIYA-MD';//𝚐𝚒𝚝𝚑𝚞𝚋 𝚛𝚎𝚙𝚘 එකක් හදලා ඒකේ නම දාන්න
    ...
    for (const admin of admins) {
        try {
            await socket.sendMessage(
                ...
                {
                    image: { url: https://files.catbox.moe/mkcgyp.jpg },
                    caption
                }
            );
        } catch (error) {
